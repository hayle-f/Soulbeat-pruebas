    ...
    return (
        <fieldset className="flex flex-col items-center gap-2 py-3 sm:px-5 border border-[#d4d4d4] dark:border-[#525252] rounded-lg bg-[#fdfdfd] dark:bg-[#2a2a2a]">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full items-center sm:justify-around">
                        <div className="flex flex-col">
                            <label className="text-sm text-[#424242] dark:text-[#c9c9c9d7]">Color:</label>
                            <input
                                type="text"
                                value={variant.color}
                        ...
                        <div className="flex flex-col">
                            <label className="text-sm text-[#424242] dark:text-[#c9c9c9d7]">Stock:</label>
                            <input
                                type="number"
                                min={0}
                                value={variant.stock}
            ...
            <button 
                ...
                onClick={() => setNewVariant({ id: productId + "-nuevo", color: "", stock: 0, imagen: "" })}
            >
                Agregar variante
            </button>
            ...
            {/* Nuevo Variant */}
            {newVariant && (
                <div className="flex flex-col px-2 py-1 items-center w-[90%] sm:flex-row gap-3 border-b border-[#d4d4d4] pb-4 md:max-w-[85%]">
                    <div className="relative w-20 h-20 flex-shrink-0">
                        {newVariant.imagen ? (
                            <img
                                src={newVariant.imagen}
                                alt="Variante"
                                className="w-20 h-20 object-cover rounded-lg border border-[#d4d4d4] dark:border-[#525252]"
                            />
                        ) : (
                    ...
                    <i
                        className="bi bi-check2 text-green-600 text-xl cursor-pointer hover:scale-110 transition-transform"
                        title="Guardar variante"
                        onClick={handleSaveNewVariant}
                    ></i>
                    <i
                        className="bi bi-x text-red-600 text-xl cursor-pointer hover:scale-110 transition-transform"
                        title="Cancelar"
